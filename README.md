...
- **Choice of provider**: Anthropic, any OpenAI-compatible endpoint (OpenAI itself, or a self-hosted/local backend — llama.cpp, Ollama, LM Studio), switchable at any time.
