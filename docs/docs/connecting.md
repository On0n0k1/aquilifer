...
- **You can disconnect a site at any time** from the extension's settings, revoking its access immediately.
...
The **Connected sites** tab in Aquilifer's settings lists every site you've approved and which provider it's bound to, with a one-click **Disconnect** for each.
